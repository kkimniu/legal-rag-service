...
- 사건, 메모, 할 일, 첨부자료, 채팅 내용 통합 검색
- 사건별 메모, 할 일, 첨부자료, 연결 채팅 활동 타임라인
- 회원가입/로그인
...
- 사건 메모 기반 AI 요약, 핵심 쟁점, 다음 할 일 생성
- 사건 메모 기반 RAG 답변
- 사건 첨부자료 업로드, 조회, 삭제
- 사건 첨부자료 텍스트 추출 및 RAG 답변 컨텍스트 반영
- 사건 첨부자료 청크 분할, ChromaDB 색인, 사건별 유사도 검색
- 사건 첨부자료 및 AI 근거 카드 원본 다운로드
- 사건별 할 일, 기한, 완료 상태 관리
- 전체 사건의 기한 초과 및 30일 이내 작업 대시보드
